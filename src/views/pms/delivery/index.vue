      ...
      <ContentWrap>
        ...
        >
          ...
          <el-form-item>
            ...
            <!--<el-button type="primary" @click="changeProjectType(2)" v-show="projectTypeShow===1">销售</el-button>-->
            <!--<el-button type="primary" @click="changeProjectType(1)" v-show="projectTypeShow===2">采购</el-button>-->
          </el-form-item>
        </el-form>
      </ContentWrap>
      <!-- 列表 -->
    ...
    <el-col :span="16">
      ...
      <ContentWrap >
        <el-tabs v-model="subTabsName">
          <el-tab-pane label="销售交付" name="deliveryList">
            <DeliveryList ref="deliveryListRef" :project-id="currentRow?.id" />
          </el-tab-pane>
        </el-tabs>
      </ContentWrap>
    </el-col>
...
/** pms 项目交付 销售 */
defineOptions({ name: 'PmsDelivery' })
...
const projectTypeShow = ref(2)//项目类型,1采购,2销售
/** 子表 */
...
const getShipping = async (ids)=>{
  //获取该项目所有发货单
  const data =await DeliveryApi.getShippingOrderByProjectId(ids)
  deliveryListRef.value.setShippingList(data)
