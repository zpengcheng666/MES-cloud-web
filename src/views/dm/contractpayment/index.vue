<template>
  ...
  <!-- 表单弹窗：添加/修改 -->
  <DMContractPaymentForm ref="formRef" @success="getList" />
</template>
...
import DMContractPaymentForm from './DMContractPaymentForm.vue'
import {DICT_TYPE, getIntDictOptions} from "@/utils/dict";

/** 合同付款 列表 */
defineOptions({ name: 'DMContractPayment' })
...
const handleSubmit = async (row) => {
  ...
  await ContractPaymentApi.submitContractPayment(row.id,processDefineKey)
