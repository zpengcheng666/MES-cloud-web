  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="formData" :stripe="true" :show-overflow-tooltip="true" >
        ...
        <template #default="scope">
          <el-tabs model-value="returnDetail">
            <el-tab-pane label="退货明细" name="returnDetail">
              <ShippingReturnDetailList :details="scope.row.returnDetailDTOList"/>
            </el-tab-pane>
          </el-tabs>
        </template>
      </el-table-column>
      <el-table-column label="退货单" align="center" prop="shippingReturnNo"   width="150"/>
      <el-table-column label="退货单名称" align="center" prop="shippingReturnName"  width="120"/>
      ...
      <el-table-column label="退货状态" align="center" prop="shippingStatus"  width="100">
        ...
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.SHIPPING_RETURN_STATUS" :value="scope.row.shippingStatus"/>
        </template>
      </el-table-column>
...
import ShippingReturnDetailList from "./ShippingReturnDetailList.vue";
