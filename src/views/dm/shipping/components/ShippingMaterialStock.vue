  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="1200">
    ...
    <ContentWrap>
      ...
      >
        ...
        <el-table-column label="物料条码" align="center" prop="variableCode"/>
        <el-table-column label="物料编号" align="center" prop="materialNumber"/>

        <el-table-column label="物料批次号" align="center" prop="batchNumber"/>
        <el-table-column label="归属项目号" align="center" prop="projectCode"/>
        <el-table-column label="归属项目" align="center" prop="projectName"/>
...
<script setup lang="ts">
  ...
  /** 物料库存 列表 */
  defineOptions({name: 'ShippingMaterialStock'})
