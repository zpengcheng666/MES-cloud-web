...
/** 供应商 表单 */
defineOptions({ name: 'DMBpmCompanyCreate' })
...
const submitForm = async () => {
  ...
  try {
    ...
    data.processKey = 'dm-company-audit'
...
onMounted(async () => {
  // 获取流程图
  const processDefinitionDetail = await DefinitionApi.getProcessDefinition(undefined,"dm-company-audit")
