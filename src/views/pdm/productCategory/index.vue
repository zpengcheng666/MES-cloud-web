    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['pdm:product-category:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['pdm:product-category:export']"
        >
      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['pdm:product-category:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['pdm:product-category:delete']"
          >
            删除
          </el-button>
        </template>
...
/** PDM 产品分类 列表 */
defineOptions({ name: 'PdmProductCategory' })
