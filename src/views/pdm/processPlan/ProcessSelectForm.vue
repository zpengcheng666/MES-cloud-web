...
/** 打开弹窗 */
const open = async (partVersionId: string, projectCode: string, projPartBomId: string) => {
  ...
  selectedProcessParams.projPartBomId = projPartBomId
  radio.value = ''
...
const getProcessData = async () => {
  processDataList.value = await ProcessPlanApi.getProcessListByPartVersionId(selectedProcessParams.partVersionId)
}
