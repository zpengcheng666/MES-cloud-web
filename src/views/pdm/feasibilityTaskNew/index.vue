...
import FeasibilityTaskForm from "./feasibilityTaskForm.vue";
...
/** 指派/编辑操作 */
const formRef=ref()
const openForm = (type: string, taskId?: string, taskIds?: string[]) => {
  formRef.value.open(type,taskId, taskIds)
}
const submitApproval = async (ids: number[], taskIds: string[]) => {
