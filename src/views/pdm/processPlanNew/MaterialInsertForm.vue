<template>
    <Dialog v-model="dialogVisible" :title="dialogTitle" width="700px">
        <ContentWrap>
            <el-form ref="queryFormRef" :inline="true" :model="queryParams" class="-mb-15px" label-width="68px">
                <el-form-item label="材料编号" prop="materialNumber">
                    <el-input v-model="queryParams.materialNumber" class="!w-240px" clearable placeholder="请输入材料编号" />
                </el-form-item>
        ...
        <ContentWrap>
            <el-table ref="multipleTable" :data="materialDataList" style="height:350px;overflow-y: auto"
                ...
                <el-table-column align="center" label="材料编号" prop="materialNumber" />
