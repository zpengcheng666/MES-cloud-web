<template>
  ...
  <!-- 表单弹窗：添加/修改 -->
  <ContractInvoiceForm ref="formRef" @success="getList" />
</template>
...
import ContractInvoiceForm from './ContractInvoiceForm.vue'
import {DICT_TYPE, getIntDictOptions} from "@/utils/dict";

/** 购销合同发票 列表 */
defineOptions({ name: 'ContractInvoice' })
...
const handleSubmit = async (row) => {
  ...
  await ContractInvoiceApi.submitContractInvoice(row.id, 'pm-contract-invoice-audit')
