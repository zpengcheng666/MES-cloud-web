    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['wms:material-stock:create']"
        >
...
<!--      <el-table-column label="ID" align="center" prop="id" />-->
      ...
      <el-table-column label="物料编号" align="center" width="170px" prop="materialNumber" />
      <el-table-column label="物料条码" align="center" width="210px" prop="barCode" />
      <el-table-column label="物料类型" align="center" width="80px" prop="materialTypeName" />
      <el-table-column label="物料批次号" align="center" width="190px" prop="batchNumber" />
...
<!--      <el-table-column label="容器满载比例" align="center" prop="byOccupancyRatio" />-->
      ...
      <el-table-column label="操作" width="120" fixed="right" align="center">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['wms:material-stock:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['wms:material-stock:delete']"
          >
            删除
          </el-button>
          <!-- <el-button
            link
            type="success"
            @click="handleStorage(scope.row.id)"
  ...
  <!-- 表单弹窗：添加/修改 -->
  <MaterialStockForm ref="formRef" @success="getList" />
</template>
...
import MaterialStorage from "@/views/wms/stock/materialstorage/index.vue";
...
provide('warehouseLocationList', warehouseLocationList)
provide('materialStorageList', materialStorageList)
// 初始化 库位 储位数据
...
const handleDelete = async (id: number) => {
  try {
    ...
    // 发起删除
    await MaterialStockApi.deleteMaterialStock(id)
...
const handleStorage = (id: any) => {
  // 跳转到物料储位页面
  push({name: MaterialStorage.name, query: { materialStockId:id }})
}
