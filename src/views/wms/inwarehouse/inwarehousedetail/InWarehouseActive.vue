  ...
  <ContentWrap>
    ...
    >
      <el-form-item label="入库库位" prop="locationId">
        <el-select v-model="formData.locationId"  placeholder="请选择入库库位" clearable filterable>
          <el-option
...
const submitForm = async () => {
  ...
  try {
    ...
    await InWarehouseDetailApi.inWarehouseAction(data.locationId,data.warehouseId)
    // resetForm();
