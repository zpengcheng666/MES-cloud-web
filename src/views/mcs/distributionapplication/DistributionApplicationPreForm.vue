  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <el-form-item label="申请单元" prop="unitId">
        <el-select v-model="formData.unitId" @change="unitSelect" placeholder="请选择申请单元">
          <el-option
      ...
      <el-form-item label="申请单元" prop="deviceId">
        <el-select clearable @clear="deviceClear" v-model="formData.deviceId" placeholder="请选择申请单元">
          <el-option
      ...
      <el-form-item label="资源类型">
        <el-checkbox-group v-model="formData.type">
          <el-checkbox v-for="dict in getStrDictOptions('wms_material_type')" :disabled="dict.value === 'DJ' && !formData.deviceId" :key="dict.value"  :label="dict.value" :value="dict.value" >
            {{dict.label}}
          </el-checkbox>
        </el-checkbox-group>
      </el-form-item>
...
import DistributionRecordForm from './components/DistributionRecordForm.vue'
