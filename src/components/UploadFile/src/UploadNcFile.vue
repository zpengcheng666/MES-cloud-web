<template>
  <div class="upload-file">
    <el-upload ref="uploadRef" v-model:file-list="fileList" :action="uploadUrl" :auto-upload="autoUpload"
      ...
      name="file" accept=".nc,.dxf,.txt,.lst,.par" :data="uploadObjs">
...
defineOptions({ name: 'UploadNcFile' })
...
const props = defineProps({
  ...
  fileType: propTypes.array.def(['nc', 'dxf', 'txt', 'lst', 'par']), // 文件类型, 例如['png', 'jpg', 'jpeg']
